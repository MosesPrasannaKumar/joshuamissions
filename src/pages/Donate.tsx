  ...
  return (
    <div className="pt-32 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="bg-white p-6 md:p-12 rounded-3xl md:rounded-[3rem] shadow-xl border border-primary/5 mb-12">
          <div className="text-center mb-12">
            <Quote className="w-8 h-8 md:w-10 md:h-10 text-secondary mx-auto mb-6" />
            <p className="font-serif italic text-xl md:text-2xl text-primary mb-4">"Each of you should give what you have decided in your heart to give, not reluctantly or under compulsion, for God loves a cheerful giver."</p>
            <p className="text-[10px] uppercase tracking-widest font-bold text-primary/40">— 2 Corinthians 9:7</p>
          </div>
